...
test2 <- split(d_permits_2, d_permits_2$permit_type)
...
js <- HTML(paste("
                ...
                var urls = ", toJSON(test2, pretty=T), ";
                ...
                console.log(`text1: ${data.points[0].text}`);
                console.log(`text2: ${urls[data.points[0].text]}`);
                console.log(`data: ${JSON.stringify(data.points[0].data, null, 2)}`);
                console.log(`url: ${data.points[0].data}`);
                // console.log(`name again: ${JSON.stringify(urls[data.points[0].data.name], null, 2)}`);
                console.log(`thinks this is click: ${JSON.stringify(urls[data.points[0].data.name][data.points[0].pointNumber], null, 2)}`);
                console.log(`tech type: ${JSON.stringify(urls[data.points[0].data.name][data.points[0].pointNumber]['technology_type'], null, 2)}`);
