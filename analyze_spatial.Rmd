...
x_df <- dbGetQuery(con,
  ...
  tmp_seldata as (
    select
      ...
      unnest(
    	...
    	geometry,
    	st_intersection(ds.geometry, tmp_selarea.geom) as area_int
    from 
  ...
  tmp_aoi as (
    select
    	...
    	ds.geometry,
    	ds.area_int,
    	st_area(ds.geometry::geography) as intersects_area_sq_m, -- whole features
    	st_area(ds.area_int::geography) as intersection_area_sq_m, -- clipped features
    	st_area(tmp_selarea.geom::geography) as aoi_area_sq_m, -- area of interest
...
# Next stop - simplify and generalize in R
