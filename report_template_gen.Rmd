...
params:
  ...
  # mgt_tethys: no  
  title: test
  aoi_wkt: POLYGON ((-122.2285 32.23642, -122.2285 35.65562, -116.7259 35.65562, -116.7259
    32.23642, -122.2285 32.23642))
  technology:
  - Current
  - Marine Energy
  lit_queries:
...
if (params$lit_tethys & !is.null(params$lit_queries))
